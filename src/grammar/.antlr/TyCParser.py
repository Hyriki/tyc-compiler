...
def serializedATN():
    return [
        ...
        0,53,55,5,48,0,0,54,50,1,0,0,0,54,51,1,0,0,0,54,52,1,0,0,0,54,53,
        1,0,0,0,55,5,1,0,0,0,56,61,5,45,0,0,57,61,5,46,0,0,58,61,5,47,0,
        0,59,61,3,16,8,0,60,56,1,0,0,0,60,57,1,0,0,0,60,58,1,0,0,0,60,59,
        1,0,0,0,61,7,1,0,0,0,62,63,5,48,0,0,63,65,5,20,0,0,64,66,3,10,5,
        ...
        1,0,0,0,77,78,5,8,0,0,78,79,5,48,0,0,79,83,5,22,0,0,80,82,3,14,7,
        ...
        0,89,90,3,4,2,0,90,91,5,48,0,0,91,92,5,24,0,0,92,15,1,0,0,0,93,102,
        ...
        0,107,108,1,0,0,0,108,109,1,0,0,0,109,110,5,48,0,0,110,112,5,20,
        ...
        0,0,0,128,126,1,0,0,0,129,130,3,4,2,0,130,131,5,48,0,0,131,25,1,
        ...
        1,0,0,0,202,205,5,48,0,0,203,204,5,44,0,0,204,206,3,36,18,0,205,
        ...
        0,228,229,6,18,-1,0,229,241,5,48,0,0,230,241,3,6,3,0,231,241,3,8,
        ...
        269,5,48,0,0,266,267,10,10,0,0,267,269,7,0,0,0,268,242,1,0,0,0,268,
...
class TyCParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "WS", "LINE_COMMENT", "BLOCK_COMMENT", 
                      ...
                      "ASSIGN", "INT_T", "FLOAT_T", "STRING_T", "IDENTIFIER", 
    ...
    def program(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 281474976711152) != 0):
                self.state = 38
                self.declaration()
                self.state = 43
                self._errHandler.sync(self)
    ...
    def structDecl(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 281474976710768) != 0):
                self.state = 80
                self.structMember()
                self.state = 85
                self._errHandler.sync(self)
    ...
    def functionDecl(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & 281474976710768) != 0):
                self.state = 111
                self.paramList()
